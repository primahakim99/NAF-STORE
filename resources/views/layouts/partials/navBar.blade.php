        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                    ...
                    <li class="{{ ($title === "Shop") ? 'nav-item active' : 'nav-item'}}"><a class="nav-link" href="#">Shop</a></li>
                    <li class="{{ ($title === "Wishlist") ? 'nav-item active' : 'nav-item'}}"><a class="nav-link" href="#">Wishlist</a></li>
                    <li class="{{ ($title === "Cart") ? 'nav-item active' : 'nav-item'}}"><a class="nav-link" href="#">Cart</a></li>
                    <li class="{{ ($title === "Checkout") ? 'nav-item active' : 'nav-item'}}"><a class="nav-link" href="#">Checkout</a></li>
                </ul>
            </div>
        </div>
        <!-- Start Side Menu -->
