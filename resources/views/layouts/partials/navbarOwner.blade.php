        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                ...
                <li class="{{ ($title === "Home") ? 'nav-item active' : 'nav-item'}}"><a class="nav-link" href="/owner">Home</a></li>
                    <li class="{{ ($title === "product_list") ? 'nav-item active' : 'nav-item'}}"><a class="nav-link" href="/productList">Product list</a></li>
                    <li class="{{ ($title === "storeOwner") ? 'nav-item active' : 'nav-item'}}"><a class="nav-link" href="/storeOwner">Store</a></li>
