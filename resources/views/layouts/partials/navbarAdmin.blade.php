        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbar-menu">
                <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                    ...
                    <li class="{{ ($title === "Store Data") ? 'nav-item active' : 'nav-item'}}"><a class="nav-link" href="/storeData">Store</a></li>
                    ...
                    <li class="{{ ($title === "Product List") ? 'nav-item active' : 'nav-item'}}"><a class="nav-link" href="/productadmin">Product</a></li>
